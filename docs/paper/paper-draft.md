...
Raw cross-persona standard deviations range from 0.4241 to 0.4800. Correcting for finite episode counts leaves estimated between-prompt SDs of 0.4182, 0.4784, 0.4408, and 0.4323 across the four repeated cells. A hierarchical bootstrap gives 95% intervals of [0.2703, 0.4876], [0.3643, 0.5123], [0.3466, 0.4892], and [0.3358, 0.4854], respectively. The corrected between-prompt component accounts for approximately 85.5%, 96.1%, 88.8%, and 90.2% of total episode-level variation. All four point estimates exceed the historical registered threshold of 0.75 times the published human SD; three of four bootstrap lower bounds do, while the first low-δ cell does not. These are fixed-panel prompt-heterogeneity estimates, not matched human latent variances.

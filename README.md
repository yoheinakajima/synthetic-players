...
**Formatted review copy:** [`docs/paper/synthetic-players-review-draft-v7.pdf`](docs/paper/synthetic-players-review-draft-v7.pdf) · [build notes](docs/paper/PDF-README.md)
...
| [`docs/paper/paper-draft.md`](docs/paper/paper-draft.md) | Current v7 Markdown manuscript |
| [`docs/paper/synthetic-players-review-draft-v7.pdf`](docs/paper/synthetic-players-review-draft-v7.pdf) | Line-numbered Explore Science review PDF with five vector figures |

...
**Formatted review copy:** [`docs/paper/synthetic-players-review-draft-v8.pdf`](docs/paper/synthetic-players-review-draft-v8.pdf) · [build notes](docs/paper/PDF-README.md)
...
| [`docs/paper/paper-draft.md`](docs/paper/paper-draft.md) | Current v8 Markdown manuscript |
| [`docs/paper/synthetic-players-review-draft-v8.pdf`](docs/paper/synthetic-players-review-draft-v8.pdf) | Line-numbered Explore Science review PDF with five vector figures |

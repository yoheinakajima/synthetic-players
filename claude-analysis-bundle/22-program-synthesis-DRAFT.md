> **WORKING DRAFT program synthesis — no new claims; the narrative skeleton [EXPLORATORY] (source: author draft over the ledgers)**
...
**Phase 5 (the layer above).** Sixteen sealed personas — trait words
only, no game-relevant content — and a temperature sweep asked whether
human-likeness could be conditioned into existence. The population-level
answer preserved the thesis: pools are corner mixtures (P5-1a, by one
unit), matching human panel variance but not shape, with one-fifth of the
human δ-response at pool level. But both of the author's registered
...
word/payoff-aligned clause, and one, p13, via the real thing: both
δ-cells interior with a positive discount-factor slope, the program's
only Family-E signature pass in five phases. Temperature, meanwhile,
...
3. **The interior is a persona property, and rare.** One bare interior
   ...
   factors are in tension (competitive + risk-averse). One persona shows
   incentive sensitivity. Existence, not prevalence.

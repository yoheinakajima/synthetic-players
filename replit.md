...
- **Phase 4 (July 2026, FROZEN — awaiting one-line approval):** complete freeze packet in `docs/phase4/freeze-packet.md` (predicates A–G: D1 64-cell representation×incentive factorial, D2 payoff-word decoupling, D3 symbol positional-attraction, E gate+slope, X2 wording-switch localization k=6 spans, F adversarial RPS at 50 rounds — 30-round gate honestly FAILED by 0.0012). Registry v3 appended (`4-proposed`, 44 templates, 250 arms, seeds 2001–3092); cross-vendor subject claude-haiku-4-5 via Replit AI Integrations Anthropic route; budget ≈18,800 calls/$261 upper bound, global kill-switch 21,000. **No Phase 4 LLM call runs until the user's approval line.** X1 report amendments applied (episode-level corners, provenance appendix §7, positioning §8)
